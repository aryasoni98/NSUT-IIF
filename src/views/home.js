...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>NSUT IIF</title>
        <meta property="og:title" content="NSUT IIF" />
      </Helmet>
      <div className="home-hero">
        ...
        <div className="home-container01">
          <div className="home-container02">
            <h1 className="home-text">JOIN NSUT LAUNCHPAD 2020!</h1>
            <span className="home-text01">
              DESIGN , BUILD AND RAPIDLY DEPLOY YOUR INNOVATIVE SOLUTIONS
            </span>
            <button className="home-button button">
              APPLY FOR NSUT LAUNCHPAD 2020
            </button>
          </div>
          <div className="home-container03">
            <button className="home-button1 button">APPLYNOW </button>
      ...
      <div className="home-section1">
        <div className="home-container04">
          <div className="home-container05">
            <h6 className="home-text02">
              <span>A Seasoned And Industry Oriented Incubator</span>
              <br></br>
            </h6>
            <h3 className="home-text05">
              <span>HOW WE HELP OUR INCUBATED STARTUPS BLOSSOM</span>
              <br className="Healine"></br>
            </h3>
          </div>
          <div className="home-cards-container">
            <div className="home-card1">
              ...
              <span className="home-text11">
                Deep dive into the world of startups with minimal risk and full
                support from our experienced business and technology mentors.
              </span>
            </div>
            <div className="home-card2">
              <div className="home-container07"></div>
              <h6 className="home-text12">
                <span>SEED INVESTMENT</span>
                <br className="TextXL"></br>
              </h6>
              <span className="home-text15">
                <span>
                  Receive seed money to develop your prototypes, set up a basic
                  sales funnel and kickstart your startup with financial
                  support.
                </span>
                <br></br>
              </span>
            ...
            <div className="home-card3">
              ...
              <h6 className="home-text18">
                <span>INNOVATION AND TRAINING</span>
                <br className="TextXL"></br>
              </h6>
              <span className="home-text21">
                <span>
                  Get trained in with the newest process methodologies like
                  design thinking, agile development, devops, rapid prototyping,
                  etc.
                </span>
                <br></br>
              </span>
          ...
          <div className="home-work-with-us">
            <div className="home-container10">
              ...
              <h3 className="home-text30">
                <span>INNOVATION AT NSUT IIF</span>
                <br className="Healine"></br>
              </h3>
              <span className="home-text33">
                <span>
                  NSUT IIF (Netaji Subhas University of Technology Innovation
                  and Incubation Foundation) is a platform for innovation and
                  entrepreneurship that aims to foster the development of
                  technology-based startups. Here are some potential areas for
                  innovation at NSUT IIF.
                </span>
                <br></br>
              </span>
            </div>
            <div className="home-container12">
              <div className="home-container13">
                <img
                  alt="image"
                  src="/playground_assets/social-cover-1400w.png"
                  className="home-image2"
                />
              </div>
              <div className="home-container14">
                <h4 className="home-text36 Healine">
                  <span className="home-text37">XEROCODEE </span>
                  <br></br>
                </h4>
                <span className="home-text39">
                  <span>
                    Build websites and edit them without writing any code! You
                    can do a lot more, including the integration of APIs and
                    even link it to your current Database.
                  </span>
                  <br></br>
                </span>
              </div>
      ...
      <div className="home-stats">
        <div className="home-stat">
          ...
          <span className="home-text45">COMMUNITY OF FOUNDERS</span>
        </div>
        <div className="home-stat1">
          <h1 className="home-text46">12 $</h1>
          <span className="home-text47">STARTUPS FUNDED</span>
        </div>
        <div className="home-stat2">
          <h1 className="home-text48">18</h1>
          <span className="home-text49">STARTUPS</span>
        </div>
        <div className="home-stat3">
          <h1 className="home-text50">30</h1>
          <span className="home-text51">AWARDS WON</span>
        </div>
      </div>
      ...
      <div className="home-section2">
        <div className="home-container16">
          <Label text="KNOW MORE ABOUT OUR INCUBATOR BEFORE"></Label>
          <h2 className="home-text52">
            <span>HOLDING OUR HANDS</span>
            <br className="Text2XL"></br>
          </h2>
          <span className="home-text55">
            <span>
              NSUT INCUBATION AND INNOVATION FOUNDATION (NSUT IIF) (section 8
        ...
        <div className="home-growing-company-section">
          <img
            alt="image"
            src="/playground_assets/screenshot%202023-02-16%20at%204.33.18%20pm-1400w.png"
            className="home-image4"
          />
          <div className="home-container17">
            <div className="home-container18">
              <svg viewBox="0 0 967.4605714285714 1024" className="home-icon02">
            ...
            <h3 className="home-text58 Healine">A growing company</h3>
            <span className="home-text59">
              NSUT-IIF won the first prize on 15 th October ‘2017 in Chennai, in
              the category “Institution Supporting Startups” sponsored by Niti
              Aayog and All India Council for Technical Education (AICTE) in
              collaboration with Vijnana Bharati (VIBHA) (IISF 2017.)
            </span>
            <div className="home-container19">
              ...
              <span className="home-text60">
                <span>NITI AAYOG AND AICTE</span>
                <br></br>
              </span>
            </div>
            <div className="home-container21">
              ...
              <span className="home-text63">DST CERTIFIED</span>
            </div>
        ...
        <div className="home-container25">
          <h6 className="home-text67">NSUT IIF </h6>
          <h3 className="home-text68">MEET OUR TEAM</h3>
          <span className="home-text69">
            <span>
              A Well Experienced Team Of Academicians And Industry Veterans With
              Expertise In The Fields Of Business And Technology
            </span>
            <br className="TextXL"></br>
          </span>
        </div>
      ...
      <div className="home-section3">
        <div className="home-container47">
          <h6 className="home-text72 TextSM">
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className="home-text74 Healine">We are missing the summer</h3>
          ...
          <div className="home-services">
            ...
            <div className="home-container48">
              ...
              <h1 className="home-text77 TextXL">Grow your market</h1>
            ...
            <div className="home-container50">
              ...
              <h1 className="home-text79 TextXL">Launch time</h1>
          ...
          <div className="home-contact">
            ...
            <h2 className="home-text81">Type in the bellow form</h2>
            <span className="home-text82 TextXL">
            ...
            <div className="home-form">
              <h1 className="home-text83">Want to work with us?</h1>
              <span className="home-text84 TextXL">
                Complete this form and we will get back to you in 24 hours.
              </span>
              <span className="home-text85 TextXS">FULL NAME</span>
              <input
                type="text"
                placeholder="Full Name"
                className="home-textinput TextSM input"
              />
              <span className="home-text86 TextXS">EMAIL</span>
              <input
                type="text"
                placeholder="Email"
                className="home-textinput1 TextSM input"
              />
              <span className="home-text87 TextXS">MESSAGE</span>
              <textarea
                cols="80"
                rows="4"
                disabled="true"
