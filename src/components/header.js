    ...
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      <div className="header-container">
        ...
        <div className="header-container2">
          <Link to="/blog-post" className="header-navlink1">
            <div className="header-container3">
              <span className="header-text TextSM">Home</span>
              <span className="header-text01 TextSM">About Us </span>
              <span className="header-text02 TextSM">Our Startups</span>
              <span className="header-text03 TextSM">
                Events &amp; Programs
              </span>
              <span className="header-text04">Achievements </span>
              <span className="header-text05">Resources </span>
              <span className="header-text06">Apply Now</span>
              <span className="header-text07">FAQs</span>
              <span className="header-text08">Contact </span>
            </div>
          </Link>
        </div>
      </div>
        ...
        <div className="header-mid">
          <Link to="/profile" className="header-navlink3">
            <div className="header-container5">
              ...
              <span className="header-text09 TextSM">PROFILE</span>
            </div>
          </Link>
          <Link to="/blog-post" className="header-navlink4">
            <div className="header-container6">
              ...
              <span className="header-text10 TextSM">BLOG</span>
            </div>
          </Link>
        </div>
...
Header.defaultProps = {
  rootClassName: '',
  image_src: '/playground_assets/favicon-200h.ico',
  heading11: 'NOTUS PRO',
  image_alt: 'image',
}
